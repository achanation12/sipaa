        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('root.todolist.update', $todolist) }}">
                        @csrf
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" name="batas" id="batas" class="form-control @error('batas') is-invalid @enderror" value="{{ $todolist->batas }}">
                        ...
                        <div class="form row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="for" id="for" class="form-control @error('for') is-invalid @enderror">
                                    <option value="{{ $todolist->forUsers->id }}">{{ $todolist->forUsers->name }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" name="judul" id="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ $todolist->judul }}">
                        ...
                        <div class="form-group row">
                            ...
                            <textarea name="isi" id="isi" cols="30" rows="10" class="form-control @error('isi') is-invalid @enderror">{{ $todolist->isi }}</textarea>
