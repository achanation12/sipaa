                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('root.karyawan.update', $karyawan) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pendidikan" type="text" class="form-control @error('pendidikan') is-invalid @enderror" name="pendidikan" value="{{ $karyawan->pendidikan }}" required autocomplete="pendidikan" autofocus>
